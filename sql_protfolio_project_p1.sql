...
ORDER BY transactions_id LIMIT 100;

-- Count the number of rows in retail_sales table.
...
-- Delete null value data records.
...
-- Data Analysis & Business Problems solvings:
